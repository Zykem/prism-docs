...
After recording with `/recordemotes`, copy all recorded animation files from `ts-recorder/recordings/processed` and paste them into `prism-emotemenu/animations` folder. The emote entries should already be in `client/AnimationList.lua` from before you recorded them.
...
<Callout type="warning">
  ...
  4. Copied the files from `ts-recorder/recordings/processed` to `prism-emotemenu/animations`
